...
export const JOBS: Job[] = [
  {
    id: "#42512-001", customer: "Auftrag 1", machine: "CD", phase: "Hauptdruck",
  ...
  {
    id: "#42512-002", customer: "Auftrag 2", machine: "RZK", phase: "Nachbereitung",
  ...
  {
    id: "#42512-003", customer: "Auftrag 3", machine: "SM5", phase: "Vordruck",
  ...
  {
    id: "#42512-004", customer: "Auftrag 4", machine: "Digi", phase: "Versandfertig",
  ...
  {
    id: "#42512-005", customer: "Auftrag 5", machine: "CD", phase: "Schneiden",
...
export const UPCOMING = [
  { id: "#42512-006", customer: "Auftrag 6", machine: "SM5" as Machine },
  { id: "#42512-007", customer: "Auftrag 7", machine: "CD" as Machine },
  { id: "#42512-008", customer: "Auftrag 8", machine: "Digi" as Machine },
];
...
export const LIVE_PRINT: LivePrintJob[] = [
  { id: "#42512-001", customer: "Auftrag 1", machine: "CD",  progress: 67, finishInMin: 45, wvInHours: 2 },
  { id: "#42512-002", customer: "Auftrag 2", machine: "RZK", progress: 32, finishInMin: 110, wvInHours: 4 },
];
...
export const WEEK_PLAN: WeekSlot[] = [
  // CD
  { machine: "CD", day: "Mo", slot: "Früh", jobId: "#42512-005", customer: "Auftrag 5", phase: "Schneiden", ownerPM: "Müller" },
  { machine: "CD", day: "Mo", slot: "Spät", jobId: "#42512-001", customer: "Auftrag 1", phase: "Vordruck", ownerPM: "Müller" },
  { machine: "CD", day: "Di", slot: "Früh", jobId: "#42512-001", customer: "Auftrag 1", phase: "Hauptdruck", ownerPM: "Müller" },
  { machine: "CD", day: "Di", slot: "Spät" },
  { machine: "CD", day: "Mi", slot: "Früh", jobId: "#42512-001", customer: "Auftrag 1", phase: "Hauptdruck", ownerPM: "Müller" },
  { machine: "CD", day: "Mi", slot: "Spät", jobId: "#42512-005", customer: "Auftrag 5", phase: "Hauptdruck", ownerPM: "Müller" },
  { machine: "CD", day: "Do", slot: "Früh", jobId: "#42512-007", customer: "Auftrag 7", phase: "Vordruck", ownerPM: "Schmidt" },
  { machine: "CD", day: "Do", slot: "Spät", jobId: "#42512-007", customer: "Auftrag 7", phase: "Hauptdruck", ownerPM: "Schmidt" },
  { machine: "CD", day: "Fr", slot: "Früh" },
  { machine: "CD", day: "Fr", slot: "Spät" },
  // RZK
  { machine: "RZK", day: "Mo", slot: "Früh", jobId: "#42512-002", customer: "Auftrag 2", phase: "Hauptdruck", ownerPM: "Schmidt" },
  { machine: "RZK", day: "Mo", slot: "Spät" },
  { machine: "RZK", day: "Di", slot: "Früh", jobId: "#42512-002", customer: "Auftrag 2", phase: "Nachbereitung", ownerPM: "Schmidt" },
  { machine: "RZK", day: "Di", slot: "Spät" },
  { machine: "RZK", day: "Mi", slot: "Früh", jobId: "#42512-002", customer: "Auftrag 2", phase: "Nachbereitung", ownerPM: "Schmidt" },
  ...
  { machine: "SM5", day: "Mo", slot: "Spät", jobId: "#42512-003", customer: "Auftrag 3", phase: "Schneiden", ownerPM: "Müller" },
  { machine: "SM5", day: "Di", slot: "Früh", jobId: "#42512-003", customer: "Auftrag 3", phase: "Vordruck", ownerPM: "Müller" },
  { machine: "SM5", day: "Di", slot: "Spät", jobId: "#42512-003", customer: "Auftrag 3", phase: "Vordruck", ownerPM: "Müller" },
  { machine: "SM5", day: "Mi", slot: "Früh", jobId: "#42512-003", customer: "Auftrag 3", phase: "Hauptdruck", ownerPM: "Müller" },
  { machine: "SM5", day: "Mi", slot: "Spät", jobId: "#42512-006", customer: "Auftrag 6", phase: "Schneiden", ownerPM: "Müller" },
  { machine: "SM5", day: "Do", slot: "Früh", jobId: "#42512-006", customer: "Auftrag 6", phase: "Hauptdruck", ownerPM: "Müller" },
  { machine: "SM5", day: "Do", slot: "Spät" },
  { machine: "SM5", day: "Fr", slot: "Früh", jobId: "#42512-006", customer: "Auftrag 6", phase: "Nachbereitung", ownerPM: "Müller" },
  { machine: "SM5", day: "Fr", slot: "Spät" },
  // Digi
  { machine: "Digi", day: "Mo", slot: "Früh", jobId: "#42512-004", customer: "Auftrag 4", phase: "Versandfertig", ownerPM: "Schmidt" },
  { machine: "Digi", day: "Mo", slot: "Spät" },
  { machine: "Digi", day: "Di", slot: "Früh" },
  { machine: "Digi", day: "Di", slot: "Spät", jobId: "#42512-008", customer: "Auftrag 8", phase: "Vordruck", ownerPM: "Müller" },
  { machine: "Digi", day: "Mi", slot: "Früh", jobId: "#42512-008", customer: "Auftrag 8", phase: "Hauptdruck", ownerPM: "Müller" },
